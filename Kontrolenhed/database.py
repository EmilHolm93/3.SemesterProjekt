...
def db_withdraw(user_id, amount, user_email):
    ...
    try:
        ...
        if result and result[0] >= Decimal(amount):  # Convert 'amount' to Decimal for comparison
            ...
            db_check_balance(user_id)  # Display updated balance
        else:
    ...
    if user_type == "maintenance":
        ...
        while True:
            ...
            if choice == '1':
                ...
                db_deposit(user_id, amount)
            elif choice == '2':
                amount = float(input("Enter amount to withdraw: "))
                db_withdraw(user_id, amount, user_email)
            elif choice == '3':
                db_check_balance(user_id)
            elif choice == '4':
                print("Logging out...")
...
def main():
    ...
    user_id, username, user_email, user_type = db_login(username, password)
